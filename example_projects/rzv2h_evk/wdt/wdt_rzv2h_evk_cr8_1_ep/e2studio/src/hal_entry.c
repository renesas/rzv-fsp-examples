...
static void enable_wdt_count_in_debug_mode(void)
{
    /* Clear this bit to Stop WDT3 from counting in debug mode */
    R_SYSC->SYS_WDT3_CTRL_b.WDTSTOPMASK = RESET_VALUE;
}
...
static void check_reset_status(void)
{
    ...
    if(R_CPG->CPG_ERROR_RST2_b.ERROR_RST3)
    {
        /* Clear the flag or the test won't work properly the second time. */
        R_CPG->CPG_ERROR_RST2_b.ERROR_RST3_WEN = 1;
        R_CPG->CPG_ERROR_RST2_b.ERROR_RST3 = 1;
        // Turn ON LED
