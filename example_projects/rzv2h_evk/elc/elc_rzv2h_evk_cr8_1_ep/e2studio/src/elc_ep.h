...
#define EP_INFO                "\r\nThis Example Project demonstrates the basic usage of  ELC driver."\
                               ...
                               "\r\nThe start source for GPT0 and GPT1 is ELC Software Event and the stop source for GPT0 is GPT1 counter overflow."\
                               "\r\nGPT0 runs in PWM mode and GPT1 runs in one-shot mode."\
