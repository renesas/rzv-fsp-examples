...
1. Project Overview:
    ...
    The I3C master on RZ/V2N demonstrates operations associated with an I3C slave running on another RZ/V2N board.
...
3. Hardware settings:
    ...
    (3) Connect Pins on RZV2N_Expansion Board between Master board and Slave board as follows:
