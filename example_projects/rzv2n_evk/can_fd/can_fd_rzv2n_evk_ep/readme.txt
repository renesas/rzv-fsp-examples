...
3. Hardware Settings:
    ...
    (4) Connect Pmod Type1/1A(CN1) PIN1 of the RZ/V2N EVK Expansion Board and Tx Pin of CAN transceiver module 1.
        Connect Pmod Type1/1A(CN1) PIN2 of the RZ/V2N EVK Expansion Board and Rx Pin of CAN transceiver module 1.
        Connect Pmod Type1/1A(CN1) PIN3 of the RZ/V2N EVK Expansion Board and Tx Pin of CAN transceiver module 2.
        Connect Pmod Type1/1A(CN1) PIN4 of the RZ/V2N EVK Expansion Board and Rx Pin of CAN transceiver module 2.
        Share the VCC and GND of 2 CAN transceiver modules and then connect them to the corresponding VCC and GND pins on the RZ/V2N EVK Expansion Board. 
        H3 HOLE of RZ/V2N EVK Expansion Board connect to VCC
