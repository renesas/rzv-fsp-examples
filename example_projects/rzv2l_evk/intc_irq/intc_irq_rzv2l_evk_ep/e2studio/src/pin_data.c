...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] =
{
     ...
     { .pin = BSP_IO_PORT_43_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT_INPUT
                 | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
     { .pin = BSP_IO_PORT_41_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT_INPUT
                 | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
};
