...
/*******************************************************************************************************************//**
 * main() is generated by the RZG2L Configuration editor and is used to generate threads if an RTOS is used.
...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\nThis Example Project demonstrates the functionality of GTM in"\
            ...
            "\r\nby user and toggles the Pmod0 pin 8 LED.\r\n");
